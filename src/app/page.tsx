...
export default function Home() {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex" style={{
      background: 'radial-gradient(circle at center, #333333 0%, #222222 30%, #111111 60%, #000000 100%)'
    }}>

      {/* 사이드바 */}
      <aside className="fixed left-0 top-0 h-full w-64 p-6 sidebar-dark">
        <div className="flex items-center gap-3 mb-8">
          <div className="w-8 h-8 rounded-lg orange-primary flex items-center justify-center shadow-orange-glow">
        ...
        <nav className="space-y-2">
          <button className="w-full text-left px-3 py-2 rounded-lg glass-dark text-white font-medium flex items-center gap-3 border-orange-primary/20">
            <div className="w-4 h-4 text-orange-primary">
          ...
          <Link href="/history">
            <button className="w-full text-left px-3 py-2 rounded-lg text-white/70 font-medium hover:glass-dark hover:text-white transition-all flex items-center gap-3">
      ...
      {/* 메인 컨텐츠 */}
      <main className="ml-64 w-full p-8 flex items-center justify-center min-h-screen  main-bg2">
        <div className="w-full max-w-6xl">
          ...
          {/* 중앙 다크 테마 카드 */}
          <div className="glass-dark-strong rounded-4xl p-8 shadow-2xl">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-xl font-bold text-white">콘텐츠 변환 & 요약</h2>
            </div>

            {/* 탭 메뉴 */}
            <div className="flex gap-1 mb-6 glass-dark p-1 rounded-xl">
              {TABS.map((t) => (
                <button
                  key={t.key}
                  onClick={() => {
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-lg font-medium transition-all duration-200 flex-1 justify-center ${
                    tab === t.key 
                      ? "orange-primary text-white shadow-orange-glow" 
                      : "text-white/70 hover:text-white hover:glass-dark"
                  }`}
                >
                  <div className="w-4 h-4">
                    {t.key === "file" && (
            ...
            {/* 업로드/입력 영역 */}
            <div
              className={`border-2 border-dashed border-white/20 rounded-2xl glass-dark flex flex-col items-center justify-center py-12 transition-all duration-300 ${
                dragActive ? "border-orange-primary shadow-orange-glow" : ""
              }`}
            ...
            >
              {tab === "file" && (
                <div className="text-center">
                  ...
                  <h3 className="text-base font-medium text-white mb-1">파일을 선택하거나 드래그해서 업로드하세요</h3>
                  <p className="text-white/70 mb-6 text-sm">지원 형식: MP3, MP4, WAV, TXT, PDF, DOC</p>
                  <input
                    type="file"
                    className="hidden"
                    id="file-upload"
                  ...
                  <label htmlFor="file-upload" className="mt-4 inline-block px-6 py-3 rounded-xl bg-black text-white font-medium cursor-pointer hover:bg-gray-800 transition-all">
              ...
              {tab === "youtube" && (
                <div className="text-center">
                  ...
                  <input
                    ...
                    className={`w-[550px] max-w-lg px-4 py-3 glass-dark border-white/20 rounded-xl text-white placeholder-white/50 focus:outline-none focus:ring-2 transition-all ${
                      youtubeUrl.trim() && !isValidYouTubeUrl(youtubeUrl.trim()) 
                        ? "border-red-400 focus:ring-red-400" 
                        : "border-white/20 focus:ring-orange-primary focus:border-orange-primary"
                    }`}
                    value={youtubeUrl}
              ...
              {tab === "text" && (
                <div className="text-center">
                  ...
                  <textarea
                    ...
                    className="w-full max-w-lg px-4 py-3 glass-dark border-white/20 rounded-xl text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-orange-primary focus:border-orange-primary min-h-[100px] resize-none"
                    value={inputText}
            ...
            <div className="flex justify-between items-center mt-8">
              <button
                className="px-6 py-3 rounded-xl orange-primary text-white font-medium hover:orange-dark transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 shadow-orange-glow"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8">
            <div className="glass-dark-card rounded-2xl p-6 shadow-lg border border-white/10">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-lg font-semibold text-white">변환 결과</h3>
                </div>
              ...
              <div className="min-h-[180px] glass-dark border border-white/10 rounded-xl p-4">
                {convertResult ? (
            ...
            <div className="glass-dark-card rounded-2xl p-6 shadow-lg border border-white/10">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg orange-secondary flex items-center justify-center shadow-orange-glow">
                    <svg viewBox="0 0 24 24" fill="white" className="w-4 h-4">
                      <path d="M3 3v18h18"/>
                      <path d="M18.7 8l-5.1 5.2-2.8-2.7L7 14.3"/>
                    </svg>
                  </div>
                  <h3 className="text-lg font-semibold text-white">요약 결과</h3>
                </div>
